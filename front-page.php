...
<main>
    ...
    <!-- Portfolio Section -->
    <?php if (get_theme_mod('my_theme_portfolio_enabled', true)) : ?>
    <section id="portfolio" class="portfolio">
        <div class="container">
            <div class="section-header">
                <span class="section-tag selector-portfolio-tag"><?php echo esc_html(get_theme_mod('my_theme_portfolio_tag', 'Our Portfolio')); ?></span>
                <h2 class="selector-portfolio-title"><?php echo esc_html(get_theme_mod('my_theme_portfolio_title', 'Featured Projects')); ?></h2>
                <p class="selector-portfolio-subtitle"><?php echo esc_html(get_theme_mod('my_theme_portfolio_subtitle', 'Showcasing our latest work and success stories')); ?></p>
            </div>
    ...
    ?>
        ...
        <section id="faq" class="faq">
            <div class="container">
                ...
                <div class="faq-grid">
                    <?php
                    $faq_items_json = get_theme_mod('my_theme_faq_items');
                    $faq_items = json_decode($faq_items_json, true);

                    if (!empty($faq_items) && is_array($faq_items)) :
                        foreach ($faq_items as $i => $item) :
                            $question = isset($item['q']) ? $item['q'] : '';
                            $answer   = isset($item['a']) ? $item['a'] : '';
                    ?>
                            <div class="faq-item">
                    ...
                    <?php
                        ...
                        $faq_defaults = array(
                            array('q' => '❓ What IT services do you offer?', 'a' => 'We offer cloud computing, cybersecurity, software development, IT consulting, data analytics, and 24/7 support.'),
                            array('q' => '❓ How long does a typical project take?', 'a' => 'Project timelines vary from 2 weeks to 3 months depending on complexity and requirements.'),
                        );
